...
const CACHE_NAME = "BulletHellWeb-cache";
const OFFLINE_URL = "BulletHellWeb.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["BulletHellWeb.html","BulletHellWeb.js","BulletHellWeb.wasm","BulletHellWeb.pck","BulletHellWeb.offline.html","BulletHellWeb.icon.png","BulletHellWeb.apple-touch-icon.png"];
